package Step.Header.Menu.ContactMenu;
...
public class ContactMenu {
    ...
    @And("^Click Button Contact$")
    public void Click_Button_Contact() throws Throwable{
        driver.findElement(By.xpath("//*[@id=\"menu_cont\"]/div/div/div[2]/ul[1]/li[8]/a")).click();
        Thread.sleep(2000);
    }
    @Then("^User Navigated to Contact Page$")
    public void User_Navigated_to_Contact_Page() throws Throwable{
        System.out.println("System Show Contact Page");
        driver.quit();
    }
}
