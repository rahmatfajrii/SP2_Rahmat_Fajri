package Step.Header.Menu.InteriorMenu;
...
public class InteriorMenu {
    ...
    @And("^Click Button Interior$")
    public void Click_Button_Interior() throws Throwable{
        driver.findElement(By.xpath("//*[@id=\"menu_cont\"]/div/div/div[2]/ul[1]/li[2]/a")).click();
        Thread.sleep(2000);
    }
    @Then("^User Navigated to Interior Page$")
    public void User_Navigated_to_Interior_Page() throws Throwable{
        System.out.println("System Show Interior Page");
        driver.quit();
    }
}
