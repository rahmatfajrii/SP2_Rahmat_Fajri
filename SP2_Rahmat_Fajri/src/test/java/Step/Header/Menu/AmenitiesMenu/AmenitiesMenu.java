package Step.Header.Menu.AmenitiesMenu;
...
public class AmenitiesMenu {
    ...
    @And("^Click Button Amenities$")
    public void Click_Button_Amenities() throws Throwable{
        driver.findElement(By.xpath("//*[@id=\"menu_cont\"]/div/div/div[2]/ul[1]/li[3]/a")).click();
        Thread.sleep(2000);
    }
    @Then("^User Navigated to Amenities Page$")
    public void User_Navigated_to_Amenities_Page() throws Throwable{
        System.out.println("System Show Amenities Page");
        driver.quit();
    }
}
